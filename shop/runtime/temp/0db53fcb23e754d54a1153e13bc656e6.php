<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\PHP\tpshop\public/../application/admin\view\goods\index.html";i:1540988403;s:48:"E:\PHP\tpshop\application\admin\view\layout.html";i:1542095099;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <form action="<?php echo url('search'); ?>" method="get" class="form-search">
                <div class="row-fluid" style="text-align: left;">
                    <div class="pull-left span4 unstyled">
                        <p> 商品名称：<input class="input-medium" name="search" type="text" value="<?php if(isset($goods_name)): ?><?php echo $goods_name; endif; ?>">
                        </p>
                    </div>
                </div>
            ...
            <table class="table table-bordered table-hover table-condensed">
                ...
                <tbody>
                    <?php foreach($data as $v): ?>
                        <tr class="success">  
                            <td><?php echo $v['id']; ?></td>
                            <td><a href="<?php echo url('admin/goods/detail',['id'=>$v['id']]); ?>"><?php echo $v['goods_name']; ?></a></td>
