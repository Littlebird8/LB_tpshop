<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\PHP\tpshop\public/../application/home\view\cart\addcart.html";i:1541834795;s:47:"E:\PHP\tpshop\application\home\view\layout.html";i:1542178499;}*/ ?>
<!DOCTYPE html>
<html>
...
<link rel="stylesheet" type="text/css" href="/static/home/css/pages-success-cart.css" />
    <div class="success-cart">
        <div class="py-container ">
            ...
            <div class="goods">
                <div class="left-good">
                    <div class="left-pic"><img src="<?php echo $goods_info['goods_logo']; ?>"></div>
                    <div class="right-info">
                        <p class="title"><?php echo $goods_info['goods_name']; ?></p>
                        <p class="attr">
                            <?php foreach($attr_info as $v): ?>
                            <?php echo $v['attr_name']; ?>：<?php echo $v['attr_value']; endforeach; ?>
                             数量：<?php echo \think\Request::instance()->param('number'); ?></p>
                    </div>
                </div>
                <div class="right-gocart">
                    <a href="<?php echo url('home/goods/detail',['id'=>$goods_info['id']]); ?>" class="sui-btn btn-xlarge">查看商品详情</a>
