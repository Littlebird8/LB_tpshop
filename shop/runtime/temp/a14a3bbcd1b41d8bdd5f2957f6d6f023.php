<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\PHP\tpshop\public/../application/home\view\cart\index.html";i:1541982534;s:47:"E:\PHP\tpshop\application\home\view\layout.html";i:1542178499;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="cart-main">
				...
				<div class="cart-item-list">
					...
					<div class="cart-body">
						...
						<div class="cart-list">
							<ul goods_id="<?php echo $v['goods_id']; ?>" goods_attr_ids="<?php echo $v['goods_attr_ids']; ?>" number="<?php echo $v['number']; ?>" cat_id="<?php echo $v['id']; ?>" class="goods-list yui3-g">
								<li class="yui3-u-1-24">
									<input type="checkbox" class="row_check" name="" id="" value="" checked/>
								</li>
								<li class="yui3-u-6-24">
									<div class="good-item">
										<div class="item-img"><img src="<?php echo $v['goods_infos']['goods_logo']; ?>" /></div>
										<div class="item-msg"><?php echo $v['goods_infos']['goods_name']; ?></div>
									</div>
								</li>
								<li class="yui3-u-5-24">
                                                                    <div class="item-txt">
                                                                        <?php foreach($v['attr_infos'] as $attrs): ?>
                                                                        <?php echo $attrs['attr_name']; ?>：<?php echo $attrs['attr_value']; ?><br>
                                                                        <?php endforeach; ?>
                                                                    </div>
								</li>
								<li class="yui3-u-1-8"><span class="price"><?php echo $v['goods_infos']['goods_price']; ?></span></li>
								<li class="yui3-u-1-8">
									<a href="javascript:void(0)" class="increment mins">-</a>
									<input autocomplete="off" type="text" value="<?php echo $v['number']; ?>" minnum="1" class="itxt current_number" />
									<a href="javascript:void(0)" class="increment plus">+</a>
								</li>
								<li class="yui3-u-1-8"><span class="sum"><?php echo $v['number']*$v['goods_infos']['goods_price']; ?></span></li>
								<li class="yui3-u-1-8">
			...
			var changetotal=function (){
				...
				$('#total_price').html('¥'+total_price.toFixed(2));
                        ...
                        var updatetodb=function(number,element){
                            ...
                            $.ajax({
                                'url':"<?php echo url('home/cart/updatenumber'); ?>",
                                'type':'post',
                                'data':data,
                                'dataType':'json',
			...
			$('.row_check').click(function(){
				...
				changetotal();
                        ...
                        $('.delete').click(function(){
                            ...
                            var that=this;
                            $.ajax({
                                'url':"<?php echo url('home/cart/del'); ?>",
                                'type':'post',
                                'data':data,
                                'dataType':'json',
                                'success':function(res){
                        ...
                        $('.sum-btn').click(function(){
                            ...
                            location.href="<?php echo url('home/order/create'); ?>"+'?cart_ids='+cat_ids;
                        });
		});
	</script>
