<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\PHP\tpshop\public/../application/home\view\login\register.html";i:1541681089;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			<div class="info">
				<form action="<?php echo url('save'); ?>" method="post" id="reg_form" class="sui-form form-horizontal">
