<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\PHP\tpshop\public/../application/admin\view\manager\create.html";i:1541422044;s:48:"E:\PHP\tpshop\application\admin\view\layout.html";i:1542095099;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <div class="well">
        ...
        <form action="<?php echo url('admin/manager/save'); ?>" method="post" id="tab">
            ...
            <label>邮箱：</label>
            <input type="text" name="email" value="" class="input-xlarge"><br>
